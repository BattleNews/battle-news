<template>
  <div class="space-y-20 sm:space-y-32 md:space-y-40 lg:space-y-44 overflow-hidden">
    <BaseSection class="mt-28" title="Les Règles du Jeu">
      <div class="flex flex-wrap justify-center pt-20">
        <RulesItem title="À la recherche des Fake News" :image-url="require('~/assets/background/CARD2.png')" translate="smallRight" rotate="2">
          <p>
          ...
          <span class="text-xl">*Fact master : Maître des faits </span>
        </RulesItem>
        <RulesItem is-red title="Réfléchissez et misez" :image-url="require('~/assets/background/CARD3.png')" translate="left" rotate="-1">
        ...
        <RulesItem title="L'issue incertaine" :image-url="require('~/assets/background/CARD1.png')" translate="right" rotate="1">
          <p>
